...
function WishBudgetExplainer({modelState,setModelState}) {

    const router = useRouter()

    return (
        <Modal isOpen={modelState} className={Styles.modal} ariaHideApp={false}>
            <h2 className={Styles.modalTitle}>How to choose budget in wish form</h2>
...
export default WishBudgetExplainer
